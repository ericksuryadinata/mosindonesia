    ...
    <div class="col-lg-12">
        <div class="card">
            ...
            <div class="card-body">
                ...
                @endforeach
                @endif
                <form class="form-horizontal" action="{{ route('admin.slider.update', $model->id) }}" method="post"
                    ...
                    <div class="form-group">
                        ...
                        <div class="controls">
                            <input class="form-control" id="title" size="16" type="text" name="title"
                                placeholder="Title of the slider" value="{{ $model->title }}">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="controls">
                            <textarea class="form-control" id="desc" name="description" cols="30" rows="10"
                                placeholder="Description of the slider">{{ $model->description }}</textarea>
                        </div>
                    </div>
                    <div class="form-group">
