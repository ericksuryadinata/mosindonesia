                    ...
                    <div class="form-group">
                        ...
                        <div class="controls">
                            <input class="form-control" id="city" size="16" type="text" name="city"
                                placeholder="Company city" value="{{ $model->city }}" required>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="controls">
                            <input class="form-control" id="email" size="16" type="text" name="email"
                                placeholder="Company email" value="{{ $model->email }}" required>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="controls">
                            <input class="form-control" id="phone" size="16" type="text" name="phone"
                                placeholder="Company phone" value="{{ $model->phone }}" required>
                    ...
                    <div class="form-group">
                        ...
                        <div class="controls">
                            <input class="form-control" id="address" size="16" type="text" name="address"
                                placeholder="Company address" value="{{ $model->address }}" required>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="controls">
                            <input class="form-control" id="g_map" size="16" type="text" name="g_map"
                                placeholder="Company address" value="{{ $model->g_map }}" required>
                        </div>
                    </div>
                    <div class="gmap">
                        {!! $model->g_map !!}
...
@section('scripts')
<script src="{{ asset('mos-panel/js/gmaps.js') }}"></script>
@stop
