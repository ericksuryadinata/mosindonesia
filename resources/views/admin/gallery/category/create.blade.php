...
@section('title', 'Add Kategori Image')
@section('breadcrumb')
    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header">
                <i class="fa fa-edit"></i>Form Category Gallery</div>
            <div class="card-body">
                ...
                @endforeach
                @endif
                <form class="form-horizontal" action="{{ route('admin.category_gallery.store') }}" method="post">
                    {{ csrf_field() }}
