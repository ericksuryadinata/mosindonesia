    ...
    <div class="col-lg-12">
        <div class="card">
            ...
            <div class="card-body">
                ...
                @endforeach
                @endif
                <form class="form-horizontal" action="{{ route('admin.exhibition.update', $model->id) }}" method="post"
                    ...
                    <div class="form-group">
                        ...
                        <div class="controls">
                            <img class="img-fluid" id="img-container" alt="Exhibition Gallery" width="100" height="100"
