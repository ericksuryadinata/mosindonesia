    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header">
                <i class="fa fa-align-justify"></i> Data Exhibitions
                <a href="{{ route('admin.exhibition.create') }}" class="btn btn-success pull-right"><i
                        class="fa fa-plus"></i> Add Exhibition</a>
            </div>
            <div class="card-body">
                ...
                <table class="table table-responsive-sm table-striped table-vertical-align">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <b>{{ $model->title }}</b> <br>
                                <span class="{{ ($model->categoryarticle) ? '':'bg-red' }}">Category :
                                    {{ ($model->categoryarticle) ? $model->categoryarticle->name:'No Category' }}</span>
                                <br>
                                ...
                                <div class="btn-group">
                                    ...
                                    <div class="dropdown-menu" x-placement="bottom-start"
                                        ...
                                        <a class="dropdown-item"
                                            href="{{ route('admin.exhibition.edit', $model->id) }}">Edit</a>
                                        <form action="{{ route('admin.exhibition.destroy', $model->id) }}"
                                            method="post">
                                            {{ csrf_field() }}
                                            {{ method_field('delete') }}
