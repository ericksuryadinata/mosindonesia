    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header">
                ...
                <a href="{{ route('admin.gallery.create') }}" class="btn btn-success pull-right"><i
                ...
                <table class="table table-responsive-sm table-striped table-vertical-align">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <b>{{ $model->title }}</b> <br>
                                <span class="{{ ($model->categorygallery) ? '':'bg-red' }}">Category :
                                    {{ ($model->categorygallery) ? $model->categorygallery->name:'No Category' }}</span>
                                <br>
                                ...
                                <div class="btn-group">
                                    ...
                                    <div class="dropdown-menu" x-placement="bottom-start"
                                        ...
                                        <a class="dropdown-item"
                                            href="{{ route('admin.gallery.edit', $model->id) }}">Edit</a>
