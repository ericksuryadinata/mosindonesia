    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header">
                ...
                <a href="{{ route('admin.gallery_video.create') }}" class="btn btn-success pull-right"><i
                                ...
                                <div class="btn-group">
                                    ...
                                    <div class="dropdown-menu" x-placement="bottom-start"
                                        ...
                                        <a class="dropdown-item"
                                            href="{{ route('admin.gallery_video.edit', $model->id) }}">Edit</a>
                                        <form action="{{ route('admin.gallery_video.destroy', $model->id) }}"
                                            method="post">
                                            {{ csrf_field() }}
                                            {{ method_field('delete') }}
