            ...
            <div class="card-body">
                ...
                <form class="form-horizontal" action="{{ route('admin.inbox.update', $model->id) }}" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <div class="controls">
                            <input class="form-control" id="email" size="16" type="email" name="email"
                    ...
                    <div class="form-group">
                        ...
                        <div class="controls">
                            <textarea class="form-control" id="respond" name="respond" cols="30" rows="10"
                                placeholder="What is your respond" required>{{ $model->respond }}</textarea>
                        </div>
                    </div>
