                    ...
                    <div class="form-group">
                        ...
                        <div class="controls">
                            <input class="form-control" id="name" size="16" type="text" name="name"
                                placeholder="User full name" value="{{ $model->name }}">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-form-label" for="username">Username</label>
                        <div class="controls">
                            <input class="form-control" id="username" size="16" type="text" name="username"
                                placeholder="Username for login" value="{{ $model->username }}">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-form-label" for="password">Password</label>
                        <div class="controls">
                            <input class="form-control" id="password" size="16" type="password" name="password"
                                placeholder="********">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="controls">
                            <input class="form-control" id="password_confirmation" size="16" type="password"
