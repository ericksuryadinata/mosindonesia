    ...
    <div class="col-lg-12">
        <div class="card">
            ...
            <div class="card-body">
                ...
                @endforeach
                @endif
                <form class="form-horizontal" action="{{ route('admin.sub_category.update', $model->id) }}"
                        ...
                        <div class="controls">
                            <select class="form-control" id="category" name="category_article_id" required>
                                ...
                                <option value="{{ $category->id }}"
                                    {{ ($category->id == $model->category_article_id) ? 'selected':'' }}>
                    ...
                    <div class="form-group">
                        ...
                        <div class="controls">
                            <input class="form-control" id="name" size="16" type="text" name="name"
                                placeholder="Name of the category" value="{{ $model->name }}" required>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="controls">
                            <textarea class="form-control" id="desc" name="description" cols="30" rows="10"
                                placeholder="Description of the category" required>{{ $model->description }}</textarea>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-form-label" for="img-container">Photo</label>
                        <div class="controls">
                            <img class="img-fluid" id="img-container" alt="Speaker " width="100" height="100"
